...
<form action="add.php" method="post">
    ...
    <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Kiểu ô tô</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="ctype">
        </div>
    </div>
    <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Gía cho thuê theo ngày</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="	drate">
        </div>
    </div>
    <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label">Gía cho thuê theo tuần</label>
        <div class="col-sm-10">
...
if (isset($_POST['Save'])) {
    ...
    //? câu lệnh
    $sql = "INSERT INTO car(vehicle_id, license_no,model , year, ctype, drate, wrate, status)
